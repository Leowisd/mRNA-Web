...
class Output extends React.Component {
  ...
  handleChart = (index) => {
    console.log("chart");
    this.state.isChartToggleOn[index] = !this.state.isChartToggleOn[index];
    this.setState(prevState => ({
      isChartToggleOn: this.state.isChartToggleOn
    }));
  }
      ...
      items = (
        <div className={style.item}>
          ...
          <div>
            ...
            <button className={style.firstlineB}>Chart</button>
          </div>
                ...
                return (
                  <div key={index}>
                    ...
                    <div className={style.chartContainer} style={{ display: this.state.isChartToggleOn[index] ? 'block' : 'none' }}>
                      <CanvasJSChart options={chartOptions[index]}
